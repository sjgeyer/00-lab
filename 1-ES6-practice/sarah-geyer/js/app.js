...
function displayPics(){
  ...
  // Changing the variable rando from 'var' to 'let' changes the scope of the variable. 'let' is only defined within the while statement inside the displayPics function, whereas 'var' was defined within the whole displayPics function.
  console.log(viewed);
